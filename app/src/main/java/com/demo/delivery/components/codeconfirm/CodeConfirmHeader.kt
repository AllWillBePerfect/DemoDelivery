...
import com.demo.delivery.utils.CodeConfirmTextFormatter.emailFormating
import com.demo.delivery.utils.CodeConfirmTextFormatter.phoneFormating
...
fun CodeConfirmHeader(
    ...
    val formattedText = remember { if (byEmailEnter) emailFormating(params)
    else phoneFormating(params) }
